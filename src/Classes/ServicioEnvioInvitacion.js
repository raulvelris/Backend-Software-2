...
var InvitacionUsuario_1 = require("./InvitacionUsuario");
var ServicioEnvioInvitacion = /** @class */ (function () {
    function ServicioEnvioInvitacion() {
    }
    ServicioEnvioInvitacion.prototype.invitarParticipante = function (eventoOrigen, destinatario) {
        return __awaiter(this, void 0, void 0, function () {
            var invitacion, invitacionUsuario;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, NotificacionFabrica_1.NotificacionFabrica.crearNotificacion(new Date(), // fecha y hora actual
                            eventoOrigen, eventoOrigen.verInvitados()[0], // siempre el primero es el emisor, se usa "!" para indicar que no es null
                            "INVITACION")];
                    case 1:
                        invitacion = _a.sent();
                        invitacionUsuario = new InvitacionUsuario_1.InvitacionUsuario(destinatario, invitacion);
    ...
    return ServicioEnvioInvitacion;
}());
