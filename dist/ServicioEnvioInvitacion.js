...
class ServicioEnvioInvitacion {
    async invitarParticipante(eventoOrigen, destinatario) {
        ...
        const invitacion = await NotificacionFabrica_1.NotificacionFabrica.crearNotificacion(new Date(), // fecha y hora actual
